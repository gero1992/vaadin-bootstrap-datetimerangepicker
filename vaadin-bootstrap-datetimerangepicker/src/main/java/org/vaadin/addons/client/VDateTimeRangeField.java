...
public class VDateTimeRangeField extends TextBoxBase {
	...
	/*
	 * Constructor. Ensures that needed html templates are added and injects a
	 * <database-visualizer> element to the page.
	 */
	public VDateTimeRangeField() {
		this(DOM.createInputText());
	}

	protected VDateTimeRangeField(Element node) {
		super(node);
		setStyleName("vaadin-bootstrap-datetimerangepicker");
		init(getElement());
	}

	public void setUpdateValueHandler(DateRangeFieldClientUpdateValueHandler updateValueHandler) {
	...
	private void onUpdateValue(JsDate start, JsDate end) {
